...
public sealed class ProspectorSearchTests : IClassFixture<SearchApiFactory>
{
    private readonly HttpClient _client;

    public ProspectorSearchTests(SearchApiFactory factory)
    ...
    {
        // Verify the JSON property names exactly match CARDS /prospector/v1/search
    ...
    [Theory]
    [InlineData("/v1/search?pageSize=0&query=test")]  // invalid pageSize - should still 200 (clamped)
    ...
    {
        // Controller clamps pageSize and page silently - should still succeed
    ...
    {
        // "simulate-timeout" triggers TimeoutException in StubProspectorSearchRepository.
