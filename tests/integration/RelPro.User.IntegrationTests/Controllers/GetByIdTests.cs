...
public sealed class GetByIdTests : IClassFixture<UserApiFactory>
{
    private readonly HttpClient _client;

    public GetByIdTests(UserApiFactory factory)
    ...
    {
        // Route constraint {id:int} rejects non-integer paths before reaching the controller.
    ...
    {
        // NoEntitlementToken maps to contractId=501 → no entitlements in StubEntitlementLoader
    ...
    {
        // userId=1099 is in org 99; caller is in org 10 - must not reveal its existence.
    ...
    {
        // userId=500 triggers an exception in StubUserRepository.
